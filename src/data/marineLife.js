...
export const threats = [
  { title: 'Food-web disruption', text: 'Warming waters, fisheries pressure, and ecosystem change can alter where prey is found and how much is available.' },
  { title: 'Habitat loss', text: 'Coastal development can remove nesting areas, nursery habitat, wetlands, seagrass, reefs, and safe shoreline access.' },
  { title: 'Bycatch & entanglement', text: 'Fishing gear can unintentionally capture, injure, or restrict marine wildlife.' },
  { title: 'Pollution', text: 'Plastic, chemicals, oil, nutrients, and lost fishing gear can affect wildlife from shorelines to the deep ocean.' },
]

export const responses = [
  { title: 'Habitat restoration', text: 'Restore reefs, seagrass, wetlands, dunes, nesting areas, and other habitats that support whole food webs.' },
