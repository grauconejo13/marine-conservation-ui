...
function SiteHeader() {
  return (
    <header className="site-header">
      <a className="brand" href="/" aria-label="Marine Conservation UI home">
  ...
  return (
    <main id="top">
      <section className="hero section-pad">
        <div className="hero-copy">
          ...
          <div className="hero-actions">
            ...
            <Link className="button secondary" to="/resources">Real conservation links</Link>
          </div>
        </div>
      ...
      <section className="cta section-pad">
        ...
        <Link className="button primary" to="/resources">Browse real conservation resources</Link>
      </section>
    </main>
  )
}
